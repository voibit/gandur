...
gandur-imgdet: clean-img
	g++ imgdet.cpp gandur.cpp -DGPU -DCUDNN -I../darknet/include -I../darknet/src/ -I/opt/cuda/include/ -ldarknet-cpp-shared -L/usr/local/lib `pkg-config --libs opencv` -L/opt/cuda/lib64 -lcuda -lcudart -lcublas -lcurand -lboost_system -lboost_filesystem -o gandurimg
